      ...
      child: Container(
        ...
        child: Row(
          children: [
            DecoratedBox(
              decoration: BoxDecoration(
                // AppColors.lightGrey3 -> colorScheme.tertiary
                    ...
                    Row(
                      ...
                      children: [
                          ...
                          child: Text(
                            ...
                            style:
                                Theme.of(context).textTheme.titleLarge!.copyWith(
                                      // AppColors.black -> colorScheme.secondary
                        ...
                        IconButton(
                          ...
                          icon: Icon(
                            Icons.more_vert,
                            // AppColors.grey -> colorScheme.onSurfaceVariant
                            color: colorScheme.onSurfaceVariant,
                          ),
                        ),
                      ],
                                ...
                                builder: (context, state) {
                                  if (state is IncrementQuantityLoading ||
                                    ...
                                    return CircularProgressIndicator(
                                      // AppColors.primaryColor -> colorScheme.primary
